...
taxaDolar = 5.60
taxaEuro = 6.60
valorDolar = valorMReais / taxaDolar
valorEuro = valorMReais / taxaEuro
print("Valor em Dólares: U$ {:.2f}".format(valorDolar))
print("Valor em Euros: € {:.2f}".format(valorEuro))
...
print("\n4------------------\n")
distanciaPercorrida = 300  # em km
combustivelGasto = 25  # em litros
consumoMedio = distanciaPercorrida / combustivelGasto
print("Distância Percorrida: {} km".format(distanciaPercorrida))
print("Combustível Gasto: {} litros".format(combustivelGasto))
...
print("Número do Funcionário: {}".format(numero_funcionario))
